...
////- Дата рождения
////- Дата принятия на работу
////- Список работников в подчинении данного Managerа
////3) Другие(руководство, секретари и т.д.)
////- ФИО
////- Дата рождения
////- Дата принятия на работу
////- Текстовое описание сотрудника
////Список сотрудников должен позволять добавлять, удалять, изменять тип сотрудника, привязывать сотрудника к Managerу, сортировать список по фамилиям, датам принятия на работу.Данные необходимо читать и писать в файл.
...
//		std::cout << " 4 - привязывать сотрудника к Managerу" << std::endl;
...
//		std::cout << " 9 - вывести список работников привязаных к Managerу" << std::endl;
...
////	
////	if (emp5->GetPositionName() == "Cleaner")
////	{
////		std::cout << "error4 Cleaner" << std::endl;
